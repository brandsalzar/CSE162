package com.brandonsalazar.lab2b;
        ...
        if(takePictureIntent.resolveActivity(getPackageManager()) != null) {
            ...
            if(photoFile != null){
                /*We are using getURIForFile(Context, String, File) which returns a content URI.
                 For more recent apps targeting Android 7.0 (API Level 24) ad higher,
                 ...
                 */
                Uri photoURI = FileProvider.getUriForFile(this, "com.brandonsalazar.android.fireproof", photoFile);
    ...
    */
    ...
    private boolean checkCameraHardware(Context context) {
        if (context.getPackageManager().hasSystemFeature(PackageManager.FEATURE_CAMERA)) {
            ...
            //check how many cameras does it have
